    ...
    <section className="py-24 bg-black relative overflow-hidden">
      ...
      <div className="container mx-auto px-6 lg:px-8 relative z-10">
        ...
        <div className="relative max-w-6xl mx-auto">
            ...
            >
              {useCases.map((useCase, index) => (
                <div key={useCase.title} className="w-full flex-shrink-0">
                  <div className="bg-gradient-to-br from-slate-800 to-slate-900 border border-slate-700 rounded-2xl p-8 mx-4 h-96">
                    <div className="grid lg:grid-cols-2 gap-8 h-full">
                      {/* Left side - Content */}
                      <div className="space-y-6">
                        <div className="flex items-center gap-4">
                          <div className={`w-12 h-12 bg-gradient-to-r ${useCase.gradient} rounded-xl flex items-center justify-center`}>
                      ...
                      <div className="flex items-center justify-center">
                        <div className="w-full bg-black/50 border border-gray-600 rounded-lg p-4">
                          ...
                          <div className="font-mono">
                            <div className="text-green-400 mb-2">$ {useCase.example}</div>
          ...
          <button
            onClick={prevSlide}
            className="absolute left-0 top-1/2 -translate-y-1/2 -translate-x-4 w-12 h-12 bg-slate-800 border border-slate-600 rounded-full flex items-center justify-center text-white hover:bg-slate-700 transition-colors duration-200"
          >
            <ChevronLeft size={20} />
          </button>
          ...
          <button
            onClick={nextSlide}
            className="absolute right-0 top-1/2 -translate-y-1/2 translate-x-4 w-12 h-12 bg-slate-800 border border-slate-600 rounded-full flex items-center justify-center text-white hover:bg-slate-700 transition-colors duration-200"
          >
